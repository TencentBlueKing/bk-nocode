...
from nocode.test.data_engine.params_operate import CREATE_PROJECT_DATA, WORKSHEET_DATA
...
class PipelineTest(TestCase):
    ...
    def setUp(self):
        ...
        project_config = {"workflow_prefix": "test", "project_key": "test2"}
        ...
        service = Service.objects.get(project_key="test2", name="test_新增")
